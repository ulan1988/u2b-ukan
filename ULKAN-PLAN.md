...
- ⏭ Остались порталы: Филиал /branch (входящие/исходящие), Склад /warehouse (остатки/приход).
  Затем Ф4 автозакуп + Ф5 авто-документы (закрытие закупа→приход, продажи→расход).
