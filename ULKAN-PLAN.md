...
- ⏭ Далее блок 2: Закуп-отчёт ← Рентабельность+цепочка; Склад ← остатки/движение; Номенклатура ←
  справочник товаров (правка/архив). + блок 1 хвосты: История, Фильтр, Настройки, порталы.
