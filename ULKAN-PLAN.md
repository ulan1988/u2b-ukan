...
- ⏭ Финальный блок: **Ф4 Автозакуп** (сводка потребности → черновик-накопитель → ProcurementLink →
  оформить закуп) + **Ф5 авто-документы** (закрытие закупа→приход в documents, продажи→расход;
  оживит Финансы/Склад/Рентабельность — «Вариант A»). Опц.: чат по карточке, суточные отчёты, реалтайм.
