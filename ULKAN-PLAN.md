...
- ⏭ Остались блок-1 хвосты: История (нужен эндпоинт истории по орг), Фильтр, Настройки (пользователи),
  + порталы (Логист/Филиал/Клиент/Склад/Трекинг). Затем Ф4 автозакуп → цепочка + авто-документы (Ф5).
