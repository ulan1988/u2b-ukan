...
import { masterShift, cashReport, addShiftExpense, closeMasterShift, incassate, remitToHQ, payWages } from '@/services/shift.service'
...
export async function POST(req: NextRequest) {
  ...
  else if (b?.action === 'remit') res = await remitToHQ(orgId, Number(b?.cash), Number(b?.kaspi), date, s)
