...
6. **Начальные остатки**: импорт из 1С (Excel) в `opening_balance`. ⏳ Нужен Excel-экспорт из 1С (сальдо контрагентов / остатки товара / деньги). Пока не пришлют — можно сделать ручной ввод начальных остатков.
